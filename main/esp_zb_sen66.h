...
#define ESP_ZB_ZCL_CLUSTER_ID_VOC_MEASUREMENT 0xFC01  // 0x042EU
#define ESP_ZB_ZCL_ATTR_VOC_MEASUREMENT_MEASURED_VALUE_ID 0x0000

#define ESP_ZB_ZCL_CLUSTER_ID_PM1_MEASUREMENT 0xFC02
#define ESP_ZB_ZCL_ATTR_PM1_MEASUREMENT_MEASURED_VALUE_ID 0x0000

#define ESP_ZB_ZCL_CLUSTER_ID_PM4_MEASUREMENT 0xFC03
#define ESP_ZB_ZCL_ATTR_PM4_MEASUREMENT_MEASURED_VALUE_ID 0x0000

#define ESP_ZB_ZCL_CLUSTER_ID_PM10_MEASUREMENT 0xFC04  // 0x042dU
#define ESP_ZB_ZCL_ATTR_PM10_MEASUREMENT_MEASURED_VALUE_ID 0x0000

#define ESP_ZB_ZCL_CLUSTER_ID_NOX_MEASUREMENT 0xFC05  // 0x042dU
